package com.example.API_zaglushka;
...
public class BucketListController {
    ...
    @PostMapping(value = "/")
    public ResponseEntity addToBucketList(@RequestParam(value = "reg") String reg,
        ...
        return ResponseEntity.ok(bucketRepository.save(new BucketList(reg, time1, time2, url, pow)));
    }
